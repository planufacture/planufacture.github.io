...
- **[Materials](/docs/materials)**: Purchase orders increase projected material availability
- **[Inventory](/docs/inventory)**: Receipts from POs update inventory levels
- **[Work Orders](/docs/work-orders)**: Material availability from POs enables production scheduling
- **[Schedule](/docs/schedule)**: Coordinate material deliveries with production timeline
- **[Batch Trace](/docs/batch-trace)**: Track material lots from suppliers through production
