...
- **[Schedule](/docs/schedule)**: Drag-and-drop work orders to balance capacity
- **[Work Orders](/docs/work-orders)**: Review and adjust work order timing based on capacity
- **[Resources](/docs/resources)**: Configure availability patterns to increase Available Hours
- **[Demand Forecast](/docs/demand-forecast)**: Compare forecasted demand against available capacity
